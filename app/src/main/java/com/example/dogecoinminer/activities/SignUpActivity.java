...
import static com.example.dogecoinminer.Config.userRegister;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private TextInputEditText nameTxt, emailTxt, passwordTxt, ReferralTxt;
    private Button signUpBtn;
    private TextView signIn;
    private String name, email, password, deviceInfo, referral;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReferralTxt = findViewById(R.id.referral_EdtTxt);
        ...
        signUpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                referral = ReferralTxt.getText().toString().trim();
